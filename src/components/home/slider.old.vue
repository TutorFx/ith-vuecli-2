<template>
    <div class="slider-container" >
        <div class="reset-slider">
            ...
            <v-carousel v-if="$vuetify.breakpoint.xs || $vuetify.breakpoint.sm && item.acf.mobile" :height="$route.name == 'Home' ? 70+'vh' : 70+'vh'" hide-delimiters>
                <v-carousel-item
                    v-for="(item,i) in items" :key="i">
                    <div>
                        <div class="img-item-wraper">
                            <div class="img-item" >
                                <v-img contain v-if="$vuetify.breakpoint.xs || $vuetify.breakpoint.sm && item.acf.mobile" position="center bottom" :style="`height: ${$route.name == 'Home' ? 70+'vh' : 70+'vh'};`" :src="item.acf.mobile ? item.acf.mobile : ''"></v-img>
                            </div>
                            <div class="botoes mb-10" :class="storage.contraste ? 'contraste':''">
            ...
            <v-carousel v-else :height="$route.name == 'Home' ? 90+'vh' : 70+'vh'" hide-delimiters>
                <v-carousel-item
                    v-for="(item,i) in items" :key="i">
                    <div>
                        <div class="img-item-wraper">
